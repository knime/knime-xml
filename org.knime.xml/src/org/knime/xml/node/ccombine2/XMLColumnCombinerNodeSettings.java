...
public class XMLColumnCombinerNodeSettings {
    ...
    static final String FILTER_CONFIGURATION = "column_filter";
    ...
    void loadSettingsDialog(final NodeSettingsRO settings,
        ...
        DataColumnSpecFilterConfiguration config = XMLColumnCombinerNodeModel.createDCSFilterConfiguration();
